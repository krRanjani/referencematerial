...
public class Sampleguru {
	...
	public static void main(String[] args)
	{
		...
		driver.findElement(By.name("uid")).sendKeys("mngr124532");
		...
		for(int i=1;i<101;i++)
		{
			...
			driver.findElement(By.name("accountno")).sendKeys("39978");
			driver.findElement(By.name("ammount")).sendKeys("999999");
